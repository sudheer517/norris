...
app.controller('FactController', ['$http','$scope', function ($http,$scope) {
    ...
    this.addForm = function () {
        ...
        $('#container1').addClass("ng-show");

        $('#container2').addClass("ng-hide");
      
    };

    this.addFact = function () {


        var url = '/SuggestFact/addSuggestion?Text=' + String(mycontroller.factText) + '&Author=' + String(mycontroller.author) + '&date=' + String(mycontroller.date);
        
        $http.get(url).success(function (data) {
            mycontroller.fact.Text = mycontroller.factText;
            mycontroller.fact.Author = mycontroller.author;
            fact.Views = 0;
            mycontroller.comments = [];
            mycontroller.factText = "";
            mycontroller.author = "";
            mycontroller.date = "";
            $('#container1').removeClass("ng-show");
            $('#container1').addClass("ng-hide");

            $('#container2').removeClass("ng-hide");
            $('#container2').addClass("ng-show");
        });
